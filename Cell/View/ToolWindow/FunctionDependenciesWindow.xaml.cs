...
{
    public partial class FunctionDependenciesWindow : ResizableToolWindow
    {
        private readonly FunctionDependenciesWindowViewModel _viewModel;
        /// <summary>
        /// Creates a new instance of the <see cref="FunctionDependenciesWindow"/>.
        /// </summary>
        /// <param name="viewModel">The view model for this view.</param>
        public FunctionDependenciesWindow(FunctionDependenciesWindowViewModel viewModel) : base(viewModel)
        {
