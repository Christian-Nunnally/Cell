...
{
    public class PluginFunctionToolWindowViewModel : PropertyChangedBase
    {
        ...
        public PluginFunctionToolWindowViewModel(ObservableCollection<PluginFunctionViewModel> pluginFunctions)
        {
